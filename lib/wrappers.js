...
exports.request = egg_swagger_decorator_3.request;
exports.summary = egg_swagger_decorator_3.summary;
const PageSchema = {
    type: 'object',
    properties: {
        total: {
...
function params(type, rules) {
    return function (target, propertyKey, descriptor) {
        ...
        egg_swagger_decorator_1.params(type)(rulesToProperties(rules || {}))(target, name, descriptor);
        return descriptor;
    };
}
 ...
 * @param rules
 */
exports.path = (rules) => params('query', rules);
/**
 * 通过 {rules} 验证 body 并生成文档
 * @param rules
 */
exports.body = (rules) => params('query', rules);
/**
 * 查询字符串信息校验
 */
...
function queryWithPager(rules, throwError) {
    return function (target, propertyKey, descriptor) {
        ...
        descriptor.value = doValidate;
        egg_swagger_decorator_1.params('query')(rulesToProperties(Object.assign(Object.assign({}, rules), exports.queryValidationRule) || {}))(target, name, descriptor);
        return descriptor;
    };
}
